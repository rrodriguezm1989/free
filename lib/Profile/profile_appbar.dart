  ...
  Widget build(BuildContext context) {
    ...
    final iconLogOut = Stack(
      children: [
        Row(
        children:  [
          TextInput(text: "log Out",color: Colors.white,),
          Row(
            children:const [
                  IconButton(
    ...
    return Stack(
      children: <Widget>[
       Expanded(child:ResponsiveLayout(mobileBodyOne: AppBar(
         backgroundColor:
         const Color(0xFF18003A),
        title:Column(
          children: <Widget>[
            Row(
                children: <Widget> [
             ...
             Logo(color: const Color(0xFFec4f0c),),
            ...
            backgroundColor: const Color(
                ...
                child: Logo(color: Color(0xFFec4f0c),),
